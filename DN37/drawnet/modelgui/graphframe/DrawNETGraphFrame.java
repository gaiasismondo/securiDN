...
public class DrawNETGraphFrame extends JInternalFrame implements
	...
	public DrawNETGraphFrame() throws DNException {
		this("Model #" + (openFrameCount + 1), new FrameLevelDataSet());
	}

	public DrawNETGraphFrame(String F, Model mo) throws DNException {
		this("Model #" + (openFrameCount + 1), new FrameLevelDataSet(F, mo,null)); // Daniele
	}

	public DrawNETGraphFrame(String F, Model mo, File file) throws DNException {
		this(file.getName(), new FrameLevelDataSet(F, mo, file)); // Daniele
	}

	public DrawNETGraphFrame(String windowName, String FilePath)
			throws DNException {
		this(
				windowName == null ? "Model #" + (openFrameCount + 1)
						: windowName, new FrameLevelDataSet(FilePath));
	}

	public DrawNETGraphFrame(String WindowName, FrameLevelDataSet Fld) {
